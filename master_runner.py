    ...
    try:
        ...
        if missing_outputs:
            for path in missing_outputs:
                log(f"FAILED: required Entertainment output missing: {path}")
            failed_scripts.append("entertainment latest_report.json verification")

        log("ENTERTAINMENT BLOCK FINISH")
